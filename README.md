...
The Weather component is used to display informations about the current weather. The data received is filtered and teh Forecast component is used to display the forecast for the next 5 days at 09:00 o'clock.
